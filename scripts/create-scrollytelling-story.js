...
<Theme base="light">
  ...
  <div class="scrollytelling-container">
    ...
    <div class="text-content">
      ...
      <section class="step">
        <BodyText class="body-text" text="Your first step content goes here. This is where you introduce your story and set the context." />
      </section>

      <section class="step">
        <BodyText class="body-text" text="Your second step content. This is where you can dive deeper into the data or narrative." />
      </section>

      <section class="step">
        <BodyText class="body-text" text="Continue adding more steps as needed. Each step will trigger a new chart or visualization." />
      </section>
